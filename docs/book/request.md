...
`setVersion(string $version) : self`                                        | Set the HTTP version for this object, one of 1.0, 1.1 or 2.0 (`AbstractMessage::VERSION_10`, `AbstractMessage::VERSION_11`, `AbstractMessage::VERSION_20`).
